...
class TestCheckArguments(unittest.TestCase):
    ...
    def test_correct(self):
        ...
        result = check_arguments(['general-aip.py', aips_dir, 'general', 'tar-bz2'])
    ...
    def test_correct_optional(self):
        ...
        aips_dir = os.path.join(os.getcwd(), 'check_arguments', 'aips_dir')
        result = check_arguments(['general-aip.py', aips_dir, 'av', 'tar', 'dpx'])
    ...
    def test_metadata_missing(self):
        ...
        result = check_arguments(['general-aip.py', aips_dir, 'web', 'tar-bz2'])
    ...
    def test_no_argument(self):
        ...
        errors = ['Required arguments are missing: aips_directory, aip_type, and zip_method.',
    ...
    def test_first_error(self):
        ...
        result = check_arguments(['general-aip.py', 'aips-dir-path-error', 'av', 'tar-bz2', 'mkv'])
    ...
    def test_second_error(self):
        ...
        aips_dir = os.path.join(os.getcwd(), 'check_arguments', 'aips_dir')
        result = check_arguments(['general-aip.py', aips_dir, 'type-error', 'tar', 'mov'])
    ...
    def test_third_error(self):
        """Test for when the third argument (zip_method) is not one of the expected values"""
        aips_dir = os.path.join(os.getcwd(), 'check_arguments', 'aips_dir')
        result = check_arguments(['general-aip.py', aips_dir, 'av', 'zip-error', 'mp4'])
        errors = [f'Provided zip_method "zip-error" is not an expected value (tar or tar-bz2).']
