...
class TestDeleteTemp(unittest.TestCase):
    ...
    def test_no_log(self):
        ...
        aip = AIP(aips_dir, 'dept', 'None', 'coll-1', 'folder', 'general', 'aip-id_no-log', 'title', 'InC', 1, True)
    ...
    def test_no_temp(self):
        ...
        # Makes the input needed for the function and runs the function being tested.
        aips_dir = os.path.join(os.getcwd(), 'delete_temp')
        aip = AIP(aips_dir, 'dept', None, 'coll-1', 'folder', 'general', 'aip-id', 'title', 'InC', 1, True)
    ...
    def test_ds_store(self):
        ...
        aip = AIP(aips_dir, 'dept', None, 'coll-1', 'folder', 'general', 'aip-id_ds-store', 'title', 'InC', 1, True)
        delete_temp(aip, os.path.join(aips_dir, aip.id), logging=True)
    ...
    def test_ds_store_2(self):
        ...
        aip = AIP(aips_dir, 'dept', None, 'coll-1', 'folder', 'general', 'aip-id_ds-store-2', 'title', 'InC', 1, True)
        delete_temp(aip, os.path.join(aips_dir, aip.id), logging=True)
    ...
    def test_thumbs_db(self):
        ...
        aip = AIP(aips_dir, 'dept', None, 'coll-1', 'folder', 'general', 'aip-id_thumbs', 'title', 'InC', 1, True)
        delete_temp(aip, os.path.join(aips_dir, aip.id), logging=True)
    ...
    def test_dot_prefix(self):
        ...
        aip = AIP(aips_dir, 'dept', None, 'coll-1', 'folder', 'general', 'aip-id_dot', 'title', 'InC', 1, True)
        delete_temp(aip, os.path.join(aips_dir, aip.id), logging=True)
    ...
    def test_tmp_extension(self):
        ...
        aip = AIP(aips_dir, 'dept', None, 'coll-1', 'folder', 'general', 'aip-id_tmp', 'title', 'InC', 1, True)
        delete_temp(aip, os.path.join(aips_dir, aip.id), logging=True)
