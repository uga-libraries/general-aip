...
class TestFullScript(unittest.TestCase):
    ...
    def test_general(self):
        ...
        expected = [['Path', 'File Name', 'Size (Bytes)', 'Date Last Modified'],
                    [os.path.join(aip_dir, 'test-001-er-000001', 'Thumbs.db'), 'Thumbs.db', 25, '2025-11-7']]
        ...
        result = make_deletion_log_list(log_path)
        expected = [['Path', 'File Name', 'Size (Bytes)', 'Date Last Modified'],
                    [os.path.join(aip_dir, 'test-001-er-000003', '.Test PDF.pdf'), '.Test PDF.pdf', 187972, '2025-11-7'],
                    [os.path.join(aip_dir, 'test-001-er-000003', 'Spreadsheet', '.Worksheet.csv'), '.Worksheet.csv', 178, '2025-11-7']]
