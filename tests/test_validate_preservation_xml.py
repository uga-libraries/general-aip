...
class TestValidatePreservationXML(unittest.TestCase):
    ...
    def test_valid(self):
        ...
        aip = AIP(aips_dir, 'test', None, 'test_c01', 'folder', 'general', 'test_c01_001', 'title', 'InC', 1, True)
        ...
        expected = f'Valid on {date.today()}'
    ...
    def test_valid_multiple_rights(self):
        ...
        # Makes the test input and runs the function.
        aips_dir = os.path.join(os.getcwd(), 'validate_preservation_xml')
        aip = AIP(aips_dir, 'test', None, 'test_c01', 'folder', 'general', 'test_c01_002', 'title', 'InC', 1, True)
        validate_preservation_xml(aip, os.path.join(os.getcwd(), 'staging'))
    ...
    def test_error_missing(self):
        ...
        aips_dir = os.path.join(os.getcwd(), 'validate_preservation_xml')
        aip = AIP(aips_dir, 'test', None, 'test_c01', 'folder', 'general', 'test_c01_003', 'title', 'InC', 1, True)
        aip.log = {'Started': '2025-08-13 02:35:00.000000', 'AIP': 'test_c01_003', 'Deletions': 'No',
        ...
        expected = [[['Time_Started', 'AIP_ID', 'Files_Deleted', 'Objects_Folder_Made', 'Metadata_Folder_Made',
                     ...
                     ['2025-08-13', 'test_c01_003', 'No', 'Success', 'Success', 'No', 'Success',
    ...
    def test_error_not_valid(self):
        ...
        # The AIP log is updated as if previous steps have run correctly.
        aips_dir = os.path.join(os.getcwd(), 'validate_preservation_xml')
        aip = AIP(aips_dir, 'test', None, 'test_c01', 'folder', 'general', 'test_c01_004', 'title', 'InC', 1, True)
        aip.log = {'Started': '2025-08-13 03:55:00.000000', 'AIP': 'test_c01_004', 'Deletions': 'No',
                   'ObjectsError': 'Success', 'MetadataError': 'Success', 'FITSTool': 'No', 'FITSError': 'Success',
                   'PresXML': 'n/a', 'PresValid': 'n/a', 'Bag': 'n/a', 'BagValid': 'n/a', 'Package': 'n/a',
                   'Manifest': 'n/a', 'Complete': 'n/a'}
        log('header', aips_dir)
        ...
        expected = [['Time_Started', 'AIP_ID', 'Files_Deleted', 'Objects_Folder_Made', 'Metadata_Folder_Made',
                     'FITS_Tool_Errors', 'FITS_Combination_Errors', 'PreservationXML_Made', 'PreservationXML_Valid',
                     'Bag_Made', 'Bag_Valid', 'Package_Errors', 'Manifest_Errors', 'Processing_Complete'],
                    ['2025-08-13', 'test_c01_004', 'No', 'Success', 'Success', 'No', 'Success', 'Success',
