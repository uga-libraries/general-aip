...
class MyTestCase(unittest.TestCase):
    ...
    def test_born_digital(self):
        ...
        Results for testing are the contents of the born_digital_current folder and the AIP log.
        """
    ...
    def test_web(self):
        ...
        Results for testing are the contents of the web_current folder and the AIP log.
        """
        # Make a copy of the test files stored in the script repo, since the test will alter the files.
